SedimentationFunction <- function(TimeStepConversion,lAkePerim,lakeArea,lakeVol,DOC_avg,MAR_sed_avg,Sed_oc_avg,NPP,DOC_SWGW,POC_conc){
  
  FunData = data.frame(BurialScalingFactor=NA,MAR_oc=NA,LeafLitter=NA,
                       LeafParameter=NA,DOC_SWGW=NA,POC_SWGW=NA,
                       POC_in_alloch=NA,POC_in_autoch=NA,POC_in=NA,
                       POC_burial=NA,POC_grazed_DIC=NA)
