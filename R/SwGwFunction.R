SWGWFunction <- function(prop_GW, DOC_GW, DOC_SW) {
  ...
  InflowData$DOC_SW <- InflowData$Q_in * (1-prop_GW) * DOC_SW * 86400 #g/d
  InflowData$DOC_GW <- InflowData$Q_in * prop_GW * DOC_GW * 86400 #g/d
  InflowData$DOC_SWGW <- (InflowData$DOC_SW + InflowData$DOC_GW) #DOC inflow g/d
